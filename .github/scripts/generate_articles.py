...
#     prompt = f"""Create a comprehensive Amazon product review article in MDX format following this exact structure. Use the provided product data to write detailed, helpful content. The output should be valid MDX with JSX components mixed with Markdown.

# ---
# publishDate: {publish_date}
# author: "Mason Everett"
# title: "Best {title}"
# excerpt: "Discover the best {base_keyword} to enhance your experience. Find top solutions based on thorough testing and reviews."
# image: {image_url}
# category: "{category}"
# tags:
# {chr(10).join(f'  - {tag}' for tag in tags)}
...
# ### 1. TOP PICKS SECTION
# Immediately after the imports, include the <TopPicks /> component.
# - id="top-picks"
...
# - items: An array of 3-4 top picks selected from the products data. For each item:
#   - category: e.g., 'Best Overall', 'Best Budget', 'Best Premium', 'Best Multi-functional'
#   - title: Product title from data
#   - description: 2-3 sentences explaining why it's picked, based on features
...
# - title: Full product title from data
...
# - description: 100-150 word paragraph covering main benefits, standout features, performance, who it's for
# - whySelected: 50-100 words on why we selected it, mentioning testing
# - userExperience: 50-100 words on typical user experiences, praises, and uses
...
# **CRITICAL INSTRUCTIONS:**
# 1. Use ACTUAL product titles, features, images, and URLs from the data above
...
def send_email_notification(titles, article_urls, recipient_email="homeessentialsguide@gmail.com"):
    from_email = "limon.working@gmail.com"
    app_password = os.environ.get("EMAIL_PASSWORD")
    if not app_password:
        print("Email password not set. Skipping email notification.")
